...
const Landing = () => {
  ...
  return (  
    <section
      id="hero"
      className="relative px-4 grid max-w-[1000px] mx-auto md:grid-cols-2 mb-20 mt-20 lg:mt-0 lg:mb-0 lg:h-screen"
    >
      <div className="flex flex-col justify-center">
        <h1 className="text-3xl lg:text-4xl font-bold font-inter">
          ¡Hola! Soy{" "}
          <span className="text-green-700" aria-label="Dilan Gerber">
            Dilan Gerber
          </span>
          , Desarrollador Web
        </h1>
        <p className="text-lg font-light max-w-xl mx-auto mt-4">
          Full Stack Developer especializado en desarrollo{" "}
          <span className="whitespace-nowrap font-semibold">back-end</span>,
          con experiencia en la creación de soluciones rápidas y escalables,
          creando sitios web optimizados y responsivos.
        </p>
      ...
      <div className="relative flex justify-center md:justify-end items-center mt-12 md:mt-0">
        ...
        >
          {/* Placeholder visible hasta que la imagen cargue */}
          {!imageLoaded && (
          ...
          <Image
            ...
            loading="eager"
            priority
            onLoadingComplete={() => setImageLoaded(true)} // Oculta el placeholder cuando la imagen cargue
          />
        </div>
      </div>
    </section>
