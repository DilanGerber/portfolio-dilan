...
{/* segunda parte que no funciona */}
      <div className=' flex space-x-16 overflow-hidden group mt-10'>
      <div className=' flex space-x-16 animate-loop-scroll-left group-hover:paused' >
